...
PROJECT_ROOT = "/home/franco/Documents/Projects/soda"
...
with DAG(
    ...
    dbt_transform = BashOperator(
        ...
        bash_command=f"dbt run --project-dir {PROJECT_ROOT}/dbt/dbt_models --select transform",
    )
    ...
    dbt_report = BashOperator(
        task_id="dbt_report",
        bash_command=f"dbt run --project-dir {PROJECT_ROOT}/dbt/dbt_models --select report",
    )
